...
from GUI.mnpbem.geometry import trirod, ComParticle, LayerStructure
...
def main() -> None:
    ...
    print('[info] === 05_bemret_layer / rod (Python) ===')
    print('[info] trirod(10,40,[15,15,15]) Au, 1nm above glass, normal incidence')
    ...
    plot_spectrum(enei, [ext, sca, absc], ['ext', 'sca', 'abs'],
        'Python BEMRetLayer rod (t={:.3f}s)'.format(t_bem),
