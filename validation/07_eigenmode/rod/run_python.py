...
from GUI.mnpbem.bem import BEMStat, BEMStatEig
...
def main() -> None:
    ...
    print('[info] === 07_eigenmode / rod (Python) ===')
    print('[info] BEMStatEig(nev=20) vs BEMStat direct, trirod(10,40,[15,15,15]) Au')
