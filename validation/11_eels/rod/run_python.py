...
from GUI.mnpbem.simulation import EELSStat, EELSRet
...
def main() -> None:
    ...
    print('[info] === 11_eels / rod (Python) ===')
    print('[info] EELS, trirod(10,40,[15,15,15]) Au, impact=[15,0], width=0.5, vel=0.5')

    epstab = [EpsConst(1.0), EpsTable('gold.dat')]
    p = ComParticle(epstab, [trirod(10.0, 40.0, n = [15, 15, 15])], [[2, 1]], [1])
