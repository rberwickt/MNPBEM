...
from GUI.mnpbem.bem import BEMStat, BEMRet, BEMStatIter, BEMRetIter
...
def setup_stat() -> ComParticle:
    epstab = [EpsConst(1), EpsTable('gold.dat')]
    return ComParticle(epstab, [trisphere(144, 20)], [[2, 1]], 1, interp = 'curv')
...
def main() -> None:
    ...
    print('[info] === 08_iterative / sphere (Python) ===')
    ...
    if ml_s is not None:
        max_rms, rms = plot_comparison(wls,
            ...
            ['direct', 'iter'],
            'stat iterative sphere comparison',
    ...
    if ml_r is not None:
        max_rms, rms = plot_comparison(wls,
            ...
            ['direct', 'iter'],
            'ret iterative sphere comparison',
