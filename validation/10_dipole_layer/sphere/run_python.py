...
from GUI.mnpbem.geometry import trisphere, ComParticle, ComPoint, LayerStructure
from GUI.mnpbem.bem import BEMStatLayer, BEMRetLayer
from GUI.mnpbem.simulation import DipoleStatLayer, DipoleRetLayer
